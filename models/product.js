...
const productSchema = new mongoose.Schema({
  ...
  // Remove index: true from slug field definition to avoid duplicate
...
// 🌐 Consolidated Index Definitions (remove duplicates)
...
productSchema.index({ slug: 1 }); // Only define here, not in field
